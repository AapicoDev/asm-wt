...
class _DatePickerExampleState extends State<DatePickerExample>
  ...
  Widget build(BuildContext context) {
    var pickStartDate = DateFormat('E, dd/MM/yyyy').format(
        DateTime.fromMillisecondsSinceEpoch(
            _startDate.value?.millisecondsSinceEpoch ?? 0));
    var pickEndDate = DateFormat('E, dd/MM/yyyy').format(
        DateTime.fromMillisecondsSinceEpoch(
            _endDate.value?.millisecondsSinceEpoch ?? 0));
    return Scaffold(
      body: Center(
        child: SizedBox(
          ...
          child: ButtonOutlineWidget(
            ...
            title: "$pickStartDate -> $pickEndDate",
          ),
        ),
      ),
    );
