...
class OverrideFormBuilderLocalizationsTh
    extends FormBuilderLocalizationsImplTh {
  OverrideFormBuilderLocalizationsTh();
...
class _LocalizationsDelegate
  ...
  Future<FormBuilderLocalizationsImpl> load(Locale locale) {
    final instance = OverrideFormBuilderLocalizationsTh();
  ...
  bool isSupported(Locale locale) =>
      OverrideFormBuilderLocalizationsTh.supportedLocales.contains(locale);
